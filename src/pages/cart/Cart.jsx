...
function Cart() {
  ...
  const shipping = cartItems.length == 0 ? 0 : parseInt(100);
  ...
  return (
    <Layout >
      <div className="h-full bg-gray-100 pt-5 md:pb-20 pb-10" style={{ backgroundColor: mode === 'dark' ? '#282c34' : '', color: mode === 'dark' ? 'white' : '', }}>
